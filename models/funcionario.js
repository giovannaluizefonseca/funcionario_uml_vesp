...
const departamento = require('./departamento') //Importanto a tabela departamento
...
/*
Não iremos criar os campos 'id_funcionario' e a chave estrangeira, pois o sequelize irá criar esses campos automaticamente, ou seja, tanto a chave primária quanto a chave estrangeira são criados pelo sequelize
*/
...
funcionario.belongsTo(departamento) //Estou dizendo que funcionario pertence a apenas 1 departamento
